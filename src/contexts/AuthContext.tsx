  ...
  const login = useCallback(async (credentials: LoginRequest) => {
    try {
      ...
      if (!access_token || !refresh_token || !userData) {
        ...
        console.error('[Login Error] Missing required fields:', { access_token: !!access_token, refresh_token: !!refresh_token, userData: !!userData });
      ...
      try {
        ...
        if (process.env.NODE_ENV === 'development') {
          console.log('[Login Debug] Cookies set. Verifying...', {
        ...
        console.error('[Login Error] Failed to set cookies:', error);
