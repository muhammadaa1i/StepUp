export default {
  ...
  offerPage: {
    ...
    intro1: 'Ushbu ommaviy oferta (keyingi o\'rinlarda - "Oferta") StepUp (keyingi o\'rinlarda - "Sotuvchi") tomonidan har qanday jismoniy shaxsga (keyingi o\'rinlarda - "Xaridor") quyida keltirilgan shartlarda mahsulotlar sotish / xizmatlar ko\'rsatish shartnomasi tuzishning rasmiy taklifdir.',
